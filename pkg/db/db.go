...
func (d *DB) CreateTable() error {
	...
	_, err = db.Exec(fmt.Sprintf("CREATE TABLE IF NOT EXISTS %s( id SERIAL, version int8, changes varchar(128), hash varchar(128), applied bool, error_message varchar(128), failed bool )", dataBaseTable))
	if err != nil {
